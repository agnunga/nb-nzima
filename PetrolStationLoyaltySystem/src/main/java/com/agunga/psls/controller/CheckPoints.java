 ...
 * @author agunga
 */
@WebServlet(name = "CheckPoints", urlPatterns = {"/checkPoints"})
public class CheckPoints extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        long noOfPoints = customerBeanI.checkPoints(MyUtility.parseLong(request.getParameter("cistomerId")));

        out.print("Points: " + noOfPoints);
