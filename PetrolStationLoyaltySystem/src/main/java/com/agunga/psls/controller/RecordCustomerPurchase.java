 ...
 * @author agunga
 */
@WebServlet(name = "RecordCustomerTransaction", urlPatterns = {"/recordCustomerTransaction"})
public class RecordCustomerPurchase extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        customer.setLitresPurchased(MyUtility.parseLong(request.getParameter("litresPurchased")));
